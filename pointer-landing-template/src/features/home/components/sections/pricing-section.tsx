...
// флаг: когда будешь готов показать цены — поставь true
const SHOW_REAL_PRICING = false

export function PricingSection() {
  if (!SHOW_REAL_PRICING) {
    return (
      <section className="w-full px-5 flex justify-center">
        <div className="relative mx-auto max-w-3xl text-center py-14 md:py-20">
          {/* лёгкое свечение для глубины, можно убрать */}
          <div
            className="pointer-events-none absolute -inset-x-24 -top-16 h-60 rounded-full blur-[120px] opacity-40 -z-10"
            style={{ background: "radial-gradient(50% 50% at 50% 0%, rgba(45,212,191,0.10), rgba(0,0,0,0))" }}
          />
          ...
          <p className="mt-3 text-base md:text-lg text-muted-foreground leading-relaxed">
            We’re in private beta. Pricing will be announced after our first pilots.
            Want early access? Join the waitlist or talk to us.
          </p>
          ...
          <div className="mt-5 text-xs uppercase tracking-wider text-teal-300/80">
            Private Alpha • Preferred pricing for design partners
          </div>
        </div>
      </section>
    )
